  ...
  return createPortal(
    <div
      className={classNames(
        "w-full max-w-sm fixed bottom-5 right-5 p-5 z-[999] text-white flex items-center justify-between rounded-md min-h-20 gap-2 transition-transform duration-300",
        {
    ...
    >
      ...
      <p className="overflow-hidden break-words grow ml-2">
        {notification?.text}
      </p>
      <button
        className="ml-10"

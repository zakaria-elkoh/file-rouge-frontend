    ...
    return (
      <div className="flex items-center justify-center min-h-[200px] gap-2">
        ...
        <h1 className="text-3xl">
          The resource you are loking for is missing!
        </h1>
      </div>
    );

  return (
    <div className="my-10 flex flex-col md:flex-row  md:min-h-[700px]  gap-10 w-full justify-end">
      ...
      <div
        className="flex max-h-[700px] flex-col bg-primary rounded-md"
        style={{ flex: "1" }}
      >
